...
const sampleResumes = [
  { id: 1, resumeName: "John Doe", jobTitle: "Software Engineer", previewUrl: "" },
  { id: 2, resumeName: "Jane Smith", jobTitle: "UX Designer", previewUrl: "" },
  { id: 3, resumeName: "Alex Johnson", jobTitle: "Data Scientist", previewUrl: "" },
  { id: 4, resumeName: "Emily Davis", jobTitle: "Product Manager", previewUrl: "" },
];
...
export default function Home() {
  ...
  const handleCreateResume = () => {
    navigate("/create-resume"); // change to your actual route
  };
